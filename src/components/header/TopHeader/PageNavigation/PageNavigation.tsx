...
const PageNavigation:FC = () => {
    let navArr = [
        {link:'/', value:'Главная', icon:false}, 
        {link:'/news', value:'Новости', icon:false},
        {link:'/404', value:'Размещение и тарифы', icon:false},
        {link:'/404', value:'Объявления на карте', icon:true},
        {link:'/contacts', value:'Контакты', icon:false}
    ]
