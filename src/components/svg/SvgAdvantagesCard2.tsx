...
const SvgAdvantagesCard2: FC <Svg> = ({style, width, height}) => {
    return (
        <svg className={style} width={width} height={height} viewBox='0 0 139 139' fill='none' xmlns='http://www.w3.org/2000/svg'>
...
export default SvgAdvantagesCard2;
