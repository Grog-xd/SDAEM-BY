...
const Registration = () => {
    ...
    const [repeatPasswordValueError, setRepeatPasswordValueError] = useState(false)
    ...
    function validation(e){
        ...
        for(let i = 0; i<profilesArr.length; i++){
            if(!loginValue || profilesArr[i].name === loginValue){
                setLoginValueError(true)
                setRegisterError(true)
                validationError = true
            }
            if(!emailMask.test(emailValue)){
            ...
            if(!repeatPasswordValue || passwordValue !== repeatPasswordValue){
                setRepeatPasswordValueError(true)
                setRegisterError(true)
                validationError = true
            }
        }
            ...
            <div className={classes.registration}>
                <form>
                    <h1>Регистрация</h1>
                    {
                        loginValueError
                            ?
                                <div className={classes.inputBlockError}>
                    ...
                    }
                    {
                        emailValueError
                            ?
                                <div className={classes.inputBlockError}>
                                    <svg width="18" height="20" viewBox="0 0 15 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button onClick={e => validation(e)} type={"submit"}>Зарегистрироваться</button>
                </form>
