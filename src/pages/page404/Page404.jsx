                ...
                <div className={classes.container}>
                    <div className={classes.mainSection}>
                        <div className={classes.textBlock}>
                            ...
                            <Link to={'/'}>
                                <svg width="12" height="12" viewBox="0 0 12 12" fill="#1E2123" xmlns="http://www.w3.org/2000/svg">
                                    <g>
                                        ...
                                        <path d="M10.4317 1.00195H8.06177L10.7846 3.47779V1.35483C10.7846 1.15995 10.6266 1.00195 10.4317 1.00195Z" fill="#1E2123"/>
                                    </g>
                                    <defs>
