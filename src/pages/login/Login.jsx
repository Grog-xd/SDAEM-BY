            ...
            <div className={classes.login}>
                ...
                <form className={classes.loginForm}>
                    ...
                    <div className={classes.inputBlock}>
                        ...
                        <input onChange={(e)=> setPasswordValue(e.target.value.toLowerCase())} value={passwordValue} placeholder={'Пароль'} type="password" name={'password'} id={'password'} minLength={3} maxLength={10} required/>
                    </div>
